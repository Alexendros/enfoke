...
> Repositorio canónico de **Enfoques**: actitudes operativas y creativas conmutables en caliente para agentes de IA (Claude Code y compatibles).

---

> 🇪🇸 **Reivindicación**: los desarrolladores y programadores españoles queremos una **traducción y adaptación de GitHub al español**. Programamos en español —aunque los lenguajes se basen en palabras inglesas—, documentamos en español y pensamos en español. Somos así de pros. _(Este repo nombra todo en español salvo el propio lenguaje de programación. A propósito.)_
