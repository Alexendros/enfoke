# Procedimiento de release de enfoke
...
- La documentación está actualizada (README, docs/).
- Se han verificado las dependencias con la herramienta correspondiente.

## Pasos

1. Mover los cambios de `[Sin publicar]` a una nueva sección con número de
   versión y fecha en `CHANGELOG.md`.
2. Actualizar la versión en el fichero `VERSIÓN`.
